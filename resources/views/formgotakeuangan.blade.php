        ...
        <div class="content-wrap">
            <div class="container clearfix">
                <div class="row">
                    ...
                    @endif
                    <div class="col-lg-6">
                        <form class="row" action="{{ route('lapkeuangan.store') }}" method="post"
                              enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="col-12 form-group">
                                <label>Nama Laporan Keuangan:</label>
                                <input type="text" name="nama_keuangan" id="nama_keuangan" class="form-control">
                            </div>
                            <div class="col-12 form-group">
                ...
                <div class="row">
                    <h6 class="text-center">Daftar Laporan Keuangan</h6>
                    <div>
                        <table class="table table-striped" id="myTable">
                            <thead>
                            <tr>
                                <th>Nama Keuangan</th>
                                <th>Tentang Keuangan</th>
                                <th>Foto</th>
                                <th>Aksi</th>
                            </tr>
                            </thead>
