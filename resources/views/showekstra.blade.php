...
@section('title')
    <title>Ekstrakurikuler {{ $data->nama }} </title>
@endsection
@section('content')
        ...
        <div class="col-lg-8">
            ...
            <div class="entry clearfix">
                ...
                <div class="entry-image">
                    <a href="demo-news-single.html"><img src="{{asset('foto_ekskul/' . $data->foto)}}" alt="Image 3"></a>
                </div>
        ...
        <div class="col-lg-4 sticky-sidebar-wrap mt-5 mt-lg-0">
            ...
            ============================================= -->
                <div class="widget clearfix">
                    <h3 class="font-secondary fw-medium h4">Ekstrakurikuler</h3>
                                ...
                                <div class="grid-inner row gutter-20">
                                    ...
                                    <div class="col-md-8">
                                        <div class="entry-title title-xs">
                                            ...
                                            <h3><a href="{{route('ekskul.show', $item->id)}}"
