...
@endpush
@section('title')
    <title>Form Prestasi Sekolah</title>
@endsection
@section('content')
    <section id="page-title">    
        <div class="container clearfix">
            <h1>Form Prestasi Sekolah</h1>
        </div>
    </section>
    <section id="content">
        <div class="content-wrap">
            <div class="container clearfix">
                <div class="row">
                    ...
                    @endif
                    <div class="col-lg-6">
                        <form class="row" action="{{ route('achievement.store') }}" method="post"
