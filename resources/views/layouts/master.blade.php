...
<html lang="en">
	<head>
		...
		<!-- Demo CSS -->
		<link rel="stylesheet" href="{{ asset('assets/css/demos/demo-startup-agency.css') }}">

		<!-- Skin CSS -->
		<link id="skinCSS" rel="stylesheet" href="{{ asset('assets/css/skins/skin-startup-agency.css') }}">
	...
	<body data-plugin-scroll-spy data-plugin-options="{'target': '#header'}">
		...
		<div class="body">
			<header id="header" class="header-effect-shrink header-transparent" data-plugin-options="{'stickyEnabled': true, 'stickyEffect': 'shrink', 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': false, 'stickyChangeLogo': true, 'stickyStartAt': 30, 'stickyHeaderContainerHeight': 70}">
				<div class="header-body header-body-bottom-border border-top-0 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="#">
											<img src="{{ asset('assets/img/smkbisa.png') }}" class="img-fluid" width="123" height="32" alt="" />
										</a>
									</div>
								</div>
							</div>
										...
										<div class="header-nav-main header-nav-main-text-capitalize header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													<li><a href="#home" class="nav-link active" data-hash data-hash-offset="0" data-hash-offset-lg="70">Home</a></li>
													<li><a href="#aboutus" class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="255">About</a></li>
													...
													<li><a href="#pricing" class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="135">Pricing</a></li>
			...
			<div role="main" class="main">
				...
				<section id="home" class="section section-with-shape-divider custom-bg-color-1 border-0 pt-0 m-0">
					...
					<div class="custom-section-svg pt-5 pb-5 pb-md-0 mb-5 mb-md-0">
						<div class="custom-section-svg-background appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="300" style="background-image: url(img/demos/startup-agency/backgrounds/morphing-bg-1.jpg); background-size: cover; background-position: center;"></div>
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
							...
							<g>
								<!-- Start -->
								<g class="appear-animation" fill="url(#gradient_SVG_3_)" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">
									<g opacity="0.2">
								...
								<g class="appear-animation" fill="url(#gradient_SVG_2_)" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700">
									<g opacity="0.5">
								...
								<g class="appear-animation" fill="url(#gradient_SVG_1_)" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="900">
							...
							<g class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="500" data-appear-animation-duration="2s">
							...
							<g class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="800" data-appear-animation-duration="2s">
						...
						<div class="container mt-5 pt-5">
							<div class="row align-items-center pt-5 mt-5 mt-lg-0 pt-lg-0">
								<div class="col-lg-6">
									<h1 class="font-weight-bold text-10 mb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">Bergabunglah Bersama Kami</h1>
									<h2 class="font-weight-medium text-8 mb-3 pb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Solusi Tepat Menjawab Tantangan</h2>
									{{-- <p class="custom-font-secondary custom-font-size-1 mb-4 pb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">Lorem ipsum dolor sit amet, consectetur adipis.</p> --}}
									<a href="#" class="btn btn-gradient text-3 font-weight-bold px-5 py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">Get Started</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-6 pb-sm-5 pb-lg-0 mb-5 mb-lg-0">
							<div class="custom-svg-wrapper-1 px-5">
								...
								<div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.1, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
									<img src="img/demos/startup-agency/about-us-1.png" class="img-fluid position-relative z-index-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="100" alt="" />
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<span class="text-color-grey positive-ls-2 font-weight-medium custom-font-size-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="00">Visi dan Misi</span>
							<h2 class="font-weight-bold text-10 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">VISI DAN MISI SMKN 1 Situbondo</h2>
							<p class="custom-font-size-3 font-weight-bold pb-2 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">VISI</p>
							<p class="custom-font-size-2 font-weight-light pb-2 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">Bermartabat, Berkualiatas dan Beriman serta Istiqomah (BERTASBIH)</p>
							<p class="custom-font-size-3 font-weight-bold pb-2 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">MISI</p>
							<p class="custom-font-size-2 font-weight-light pb-2 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">Membimbing siswa untuk melaksanakan agama yang dianut dengan konsekuen.</p>
							<a href="#footer" data-hash data-hash-offset="0" data-hash-offset-lg="70" class="btn btn-gradient text-3 font-weight-bold px-5 py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="000">Contact Us</a>
						</div>
					</div>
				</div>
					...
					<div class="container position-relative z-index-3 pt-md-5 pb-1 pb-sm-5 my-5">
						<div class="row justify-content-center pt-5">
							<div class="col-lg-10 text-center">
								<span class="text-color-grey positive-ls-2 font-weight-medium custom-font-size-2 d-block mb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="00">WAKIL KEPALA SEKOLAH</span>
														...
														<div class="card-body p-3">
															<div class="thumb-info thumb-info-hide-wrapper-bg mb-3 pb-2">
																<div class="thumb-info-wrapper">
																	<img src="{{ asset('assets/img/bapak-waka.png') }}" class="img-fluid" alt="John Doe" />
																</div>
															</div>
															<h3 class="text-center font-weight-bold text-capitalize line-height-1 text-5 text-color-hover-primary mb-0">Bapak/Ibu WAKA</h3>
															<p class="text-center text-color-grey text-2 mb-2">WAKA Bidang kurikulum</p>
														</div>
													</div>
												</a>
											</div>
												...
												<a href="#" class="text-decoration-none">
													<div class="card custom-card-style-1 box-shadow-4 my-3">
														<div class="card-body p-3">
															<div class="thumb-info thumb-info-hide-wrapper-bg mb-3 pb-2">
																<div class="thumb-info-wrapper">
																	<img src="{{ asset('assets/img/ibu-waka.png') }}" class="img-fluid" alt="John Doe" />
																</div>
															</div>
															<h3 class="text-center font-weight-bold text-capitalize line-height-1 text-5 text-color-hover-primary mb-0">Bapak/Ibu WAKA</h3>
															<p class="text-center text-color-grey text-2 mb-2">WAKA Bidang Kesiswaan</p>
														</div>
													</div>
												</a>
											</div>
												...
												<a href="#" class="text-decoration-none">
													<div class="card custom-card-style-1 box-shadow-4 my-3">
														<div class="card-body p-3">
															...
															<h3 class="text-center font-weight-bold text-capitalize line-height-1 text-5 text-color-hover-primary mb-0">Bapak/Ibu WAKA</h3>
															<p class="text-center text-color-grey text-2 mb-2">WAKA Bidang Sarana & Prasarana</p>
														</div>
													</div>
												</a>
											</div>
												...
												<a href="#" class="text-decoration-none">
													<div class="card custom-card-style-1 box-shadow-4 my-3">
														<div class="card-body p-3">
															...
															<h3 class="text-center font-weight-bold text-capitalize line-height-1 text-5 text-color-hover-primary mb-0">Bapak/Ibu WAKA</h3>
															<p class="text-center text-color-grey text-2 mb-2">WAKA Bidang Kehumasan</p>
														</div>
													</div>
												</a>
											</div>
												...
												<a href="#" class="text-decoration-none">
													<div class="card custom-card-style-1 box-shadow-4 my-3">
														<div class="card-body p-3">
															<div class="thumb-info thumb-info-hide-wrapper-bg mb-3 pb-2">
																<div class="thumb-info-wrapper">
																	<img src="{{ asset('assets/img/demos/startup-agency/authors/author-2.jpg') }}" class="img-fluid" alt="John Doe" />
																</div>
															</div>
								...
								<div class="owl-carousel custom-carousel-backward-shape custom-dots-style-1 custom-dots-style-1-light" data-plugin-options="{'responsive': {'0': {'items': 1, 'stagePadding': 100}, '479': {'items': 1, 'stagePadding': 100}, '768': {'items': 3, 'stagePadding': 100}, '992': {'items': 3, 'stagePadding': 100}, '1200': {'items': 4}}, 'autoplay': true, 'autoplayTimeout': 5000, 'autoplayHoverPause': true, 'dots': true, 'nav': false, 'center': true, 'loop': true, 'margin': 25}">
										...
										<a href="#">
											<div class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
												<div class="thumb-info-wrapper rounded-0">
													<img src="{{ asset('assets/img/demos/startup-agency/works/work-1.jpg') }}" class="img-fluid rounded-0" alt="Work 1" />
												</div>
											</div>
										</a>
									</div>
									<div class="my-5">
										<a href="#">
											<div class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
												<div class="thumb-info-wrapper rounded-0">
													<img src="{{ asset('assets/img/demos/startup-agency/works/work-2.jpg') }}" class="img-fluid rounded-0" alt="Work 2" />
												</div>
											</div>
										</a>
									</div>
									<div class="my-5">
										<a href="#">
											<div class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
												<div class="thumb-info-wrapper rounded-0">
													<img src="{{ asset('assets/img/demos/startup-agency/works/work-3.jpg') }}" class="img-fluid rounded-0" alt="Work 3" />
												</div>
											</div>
										</a>
									</div>
									<div class="my-5">
										<a href="#">
											<div class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
												<div class="thumb-info-wrapper rounded-0">
													<img src="{{ asset('assets/img/demos/startup-agency/works/work-4.jpg') }}" class="img-fluid rounded-0" alt="Work 4" />
												</div>
											</div>
										</a>
									</div>
									<div class="my-5">
										<a href="#">
											<div class="thumb-info thumb-info-hide-wrapper-bg custom-thumb-info-hover-1 box-shadow-4 rounded-0 my-3">
												<div class="thumb-info-wrapper rounded-0">
													<img src="{{ asset('assets/img/demos/startup-agency/works/work-5.jpg') }}" class="img-fluid rounded-0" alt="Work 5" />
												</div>
											</div>
										</a>
									</div>
				...
				<div class="container mt-4 mb-5">
					<div id="pricing" class="row justify-content-center">
						<div class="col-lg-10 text-center">
							<span class="text-color-grey positive-ls-2 font-weight-medium custom-font-size-2 d-block appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="00">OUR PRICES</span>
							<h2 class="font-weight-bold text-10 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Best Price Guarantee</h2>
					...
					<div class="custom-svg-wrapper-3">
						...
						<div class="pricing-table custom-pricing-table-style-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
							<div class="col-md-6 col-lg-3">
								<div class="plan">
									...
									<div class="plan-price">
										<span class="price"><span class="price-unit">$</span>19</span>
									...
									<div class="plan-footer">
										<a href="#" class="btn btn-dark text-3 font-weight-bold border-0 btn-px-5 py-3">Get Started</a>
									</div>
								</div>
							</div>
							<div class="col-md-6 col-lg-3">
					...
					<div class="container position-relative z-index-3 pt-2 pt-md-5 pb-1 pb-md-5 mt-5 mb-5 mb-lg-0 mb-xl-5">
						<div class="row pb-2 mt-5 mb-5">
							<div class="col text-center">
								<span class="text-color-grey positive-ls-2 font-weight-medium custom-font-size-2 d-block appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="00">OUR BLOG</span>
								<h2 class="font-weight-bold text-10 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">What Is Happening</h2>
							</div>
						</div>
						<div class="row mb-5">
									...
									<div>
										<article class="mb-5">
											<div class="d-flex justify-content-center line-height-1 text-1 pb-1 mb-2">
												<a href="#" class="text-color-default text-color-hover-primary text-decoration-none">10 JAN 2020</a>
												<a href="#" class="text-color-default text-color-hover-primary text-decoration-none custom-divider-1">3 COMMENTS</a>
												<span class="text-color-default">JOHN DOE</span>
											</div>
											<h4 class="font-weight-bold text-6 text-center"><a href="#" class="text-color-dark text-color-hover-primary text-decoration-none">Lorem ipsum dolor sit amet</a></h4>
											<p class="custom-font-secondary text-center text-4 mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur...</p>
											<a href="#" class="d-block font-weight-semibold text-color-secondary text-color-hover-primary text-decoration-none text-center">READ MORE +</a>
										</article>
									</div>
									<div>
										<article class="mb-5">
								...
								<div class="row">
										...
										<div class="row pb-5 mb-5">
											<div class="col">
												<div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
													<img class="icon-animated" width="55" src="{{ asset('assets/img/demos/startup-agency/icons/icon-location.svg') }}" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
										...
										<div class="row">
											<div class="col">
												<div data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.1, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
													<img class="icon-animated" width="55" src="{{ asset('assets/img/demos/startup-agency/icons/icon-mail.svg') }}" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-secondary mb-3'}" />
									...
									<div class="col-lg-6 pt-5">
										...
										<div class="row pb-5 mb-5">
											<div class="col">
												<div data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.2, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
													<img class="icon-animated" width="55" src="{{ asset('assets/img/demos/startup-agency/icons/icon-phone.svg') }}" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-secondary mb-3'}" />
										...
										<div class="row">
											<div class="col">
												<div data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.1, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
													<img class="icon-animated" width="55" src="{{ asset('assets/img/demos/startup-agency/icons/icon-calendar.svg') }}" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary mb-3'}" />
...
<script src="{{ asset('assets/vendor/kute/kute.min.js') }}"></script>
...
<!-- Demo -->
<script src="{{ asset('assets/js/demos/demo-startup-agency.js') }}"></script>
