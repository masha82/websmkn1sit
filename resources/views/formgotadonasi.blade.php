        ...
        <div class="content-wrap">
            <div class="container clearfix">
                <div class="row">
                    ...
                    @endif
                    <div class="col-lg-6">
                        <form class="row" action="{{ route('donasi.store') }}" method="post"
                              enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="col-12 form-group">
                                <label>Nama Donasi:</label>
                                <input type="text" name="nama_donasi" id="nama_donasi" class="form-control">
                            </div>
                            <div class="col-12 form-group">
                                <label>Tentang Donasi:</label>
                ...
                <div class="row">
                    <h6 class="text-center">Daftar Donasi</h6>
                    <div>
                        <table class="table table-striped" id="myTable">
                            <thead>
                            <tr>
                                <th>Nama Donasi</th>
                                <th>Tentang Donasi</th>
                                <th>Foto</th>
                                <th>Aksi</th>
                            </tr>
                            </thead>
