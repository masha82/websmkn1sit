        ...
        <div class="content-wrap">
            <div class="container clearfix">
                <div class="row">
                    ...
                    @endif
                    <div class="col-lg-6">
                        <form class="row" action="{{ route('jadwalmapel.store') }}" method="post"
                ...
                <div class="row">
                    <h6 class="text-center">Daftar Jadwal Pelajaran</h6>
                    <div>
