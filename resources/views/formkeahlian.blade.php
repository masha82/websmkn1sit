...
@endpush
@section('title')
    <title>Form Keahlian/Jurusan</title>
@endsection
@section('content')
    <section id="page-title">    
        <div class="container clearfix">
            <h1>Form Keahlian/Jurusan</h1>
        </div>
    </section>
    <section id="content">
        <div class="content-wrap">
            <div class="container clearfix">
                    ...
                    <div class="col-lg-6">
                        <form class="row" action="{{ route('jurusan.store') }}" method="post"
                            ...
                            <div class="col-12 form-group">
                                <label>Nama Keahlian/Jurusan:</label>
                ...
                <div class="row">
                    <h6 class="text-center">Daftar Keahlian/Jurusan</h6>
                    <div>
