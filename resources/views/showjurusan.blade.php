...
@section('title')
    <title>Jurusan {{ $data->judul }}</title>
@endsection
@section('content')
        ...
        ============================================= -->
            <div class="col-lg-8">
                <div class="entry clearfix">
                    <h2 class="mb-3 fw-bold h1"> {{$data->nama_keahlian}}</h2>
                    ...
                    <div class="entry-image">
                        <a href="demo-news-single.html"><img src="{{asset('foto_kompetensi/' . $data->foto)}}" alt="Image 3"></a>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="entry-image">
                            <img src="{{asset('foto_jurusan/'.$item->foto)}}" alt="Image 3">
                        </div>
                        @endforeach
                    </div>    
                </div>
                                    ...
                                    <div class="grid-inner row gutter-20">
                                        <div class="col-md-4">
                                            <a class="entry-image" href="#"><img
                                                    src="{{ asset('foto_kompetensi/' . $item->foto) }}"
                                                    alt="Image"></a>
                                        </div>
                                        <div class="col-md-8">
