...
class AboutschoolController extends Controller
{
    ...
    protected $route = 'tentangsekolah';
    public function index()
    {
        $data = Aboutsch::orderBy('created_at', 'DESC')->first();
        return view('school', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $file->move(public_path("gambar_about"), $new_name);
        $data['foto'] = $new_name;
        Aboutsch::create($data);
    ...
    public function edit($id)
    {
        ...
        return view('editschool', compact('data'));
    }
